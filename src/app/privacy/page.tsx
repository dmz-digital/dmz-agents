    ...
    return (
        <div className="min-h-screen bg-[#050505] text-white font-jakarta selection:bg-dmz-accent">
            ...
            <div className="fixed top-0 left-0 w-full h-full pointer-events-none overflow-hidden z-0">
                ...
                <div className="absolute bottom-[-10%] right-[-10%] w-[30%] h-[30%] bg-dmz-accent/5 blur-[120px] rounded-full" />
            </div>
            ...
            <main className="relative z-10 max-w-4xl mx-auto px-6 py-24">
                ...
                >
                    ...
                    <p className="text-neutral-500 mb-16 text-lg">
                        ...
                        <strong> soberania de dados</strong> por design.
                    </p>

                    <div className="grid md:grid-cols-2 gap-6 mb-16">
                        <div className="bg-white/5 border border-white/10 p-8 rounded-3xl">
                            <Eye className="text-dmz-accent mb-4" size={24} />
                            <h3 className="text-lg font-bold mb-2">Transparência Total</h3>
                            <p className="text-sm text-neutral-400">Rastreamos cada decisão do agente para que você saiba exatamente como seus dados são processados.</p>
                        </div>
                        <div className="bg-white/5 border border-white/10 p-8 rounded-3xl">
                            <Database className="text-blue-500 mb-4" size={24} />
                            <h3 className="text-lg font-bold mb-2">Isolamento de Dados</h3>
                            <p className="text-sm text-neutral-400">Projetos operam em silos lógicos. Seus dados nunca são usados para treinar modelos globais.</p>
                        </div>
                    </div>

                    <div className="space-y-12 text-neutral-400 leading-relaxed text-lg mb-24">
                        <section className="space-y-4">
                            <h2 className="text-2xl font-bold text-white">Coleta de Informações</h2>
                            <p>
                        ...
                        <section className="space-y-4">
                            <h2 className="text-2xl font-bold text-white">LGPD & Compliance</h2>
                            <p>
                        ...
                        <section className="space-y-4">
                            <h2 className="text-2xl font-bold text-white">Processamento via Terceiros</h2>
                            <p>
                    ...
                    <div className="p-8 bg-blue-600/10 border border-blue-600/20 rounded-3xl flex flex-col md:flex-row items-center gap-6">
                        <Globe className="text-blue-500 shrink-0" size={40} />
                        <div>
                            <h4 className="font-bold text-white mb-1">Dúvidas sobre Proteção de Dados?</h4>
            ...
            <footer className="py-12 border-t border-white/5 text-center text-[10px] text-neutral-600 uppercase font-black tracking-widest">
                DMZ Labs Privacy Framework v2.0
            </footer>
        </div>
    );
}
