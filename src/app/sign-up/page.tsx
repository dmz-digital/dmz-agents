                                ...
                                <div className="space-y-4">
                                    <div className="grid grid-cols-2 gap-3">
                                        <button
                                            ...
                                            type="button"
                                            className="w-full bg-white border border-neutral-200 py-3.5 rounded-2xl font-bold text-sm text-neutral-700 flex items-center justify-center gap-2 hover:bg-neutral-50 hover:border-neutral-300 hover:-translate-y-0.5 active:scale-[0.98] transition-all"
                                        >
                                        ...
                                        <button
                                            ...
                                            type="button"
                                            className="w-full bg-neutral-900 text-white py-3.5 rounded-2xl font-bold text-sm flex items-center justify-center gap-2 hover:bg-neutral-800 hover:-translate-y-0.5 active:scale-[0.98] transition-all border border-neutral-800"
                                        >
