            ...
            <div className="w-full max-w-md relative z-20">
                ...
                <div className="bg-white border border-neutral-100 shadow-2xl shadow-neutral-200/50 rounded-[32px] p-10">
                    ...
                    <button
                        ...
                        type="button"
                        className="w-full bg-white border border-neutral-200 py-3.5 rounded-2xl font-bold text-sm text-neutral-600 flex items-center justify-center gap-3 hover:bg-neutral-50 hover:border-neutral-300 hover:-translate-y-0.5 active:scale-[0.98] transition-all cursor-pointer"
                    >
                    ...
                    <button
                        ...
                        type="button"
                        className="mt-3 w-full bg-neutral-900 text-white py-3.5 rounded-2xl font-bold text-sm flex items-center justify-center gap-3 hover:bg-neutral-800 hover:-translate-y-0.5 active:scale-[0.98] transition-all border border-neutral-800 cursor-pointer"
                    >
